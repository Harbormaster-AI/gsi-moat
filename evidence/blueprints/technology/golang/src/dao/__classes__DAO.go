...
//----------------------------------------------------------------------------
func Assign${roleName}To${parentName}( ${lowercaseClassName}Id uint64, ${lowercaseRoleName}Id uint64 )(utils.RequestResult){
...
//----------------------------------------------------------------------------
func Unassign${roleName}From${parentName}(${lowercaseClassName}Id uint64)(utils.RequestResult) {
	...
	if parentRequestResult.Success == true {
		...
		//----------------------------------------------------------------------------
		${parentName}Obj.${roleName} = nil;

		//----------------------------------------------------------------------------
		// assign  nil to the ${roleName}
		//----------------------------------------------------------------------------
		${parentName}Obj.${roleName}Id = nil;
...
//----------------------------------------------------------------------------
func Add${roleName}To${parentName} ( ${lowercaseClassName}Id uint64, ${lowercaseRoleName}Ids string )(utils.RequestResult) {
...
//----------------------------------------------------------------------------
func Remove${roleName}From${parentName}( ${lowercaseClassName}Id uint64, ${lowercaseRoleName}Ids string )(utils.RequestResult) {
	//----------------------------------------------------------------------------
	// Obtain the ${parentName} with the matching identifier
	//----------------------------------------------------------------------------
	parentRequestResult := Get${parentName}(${lowercaseClassName}Id)
