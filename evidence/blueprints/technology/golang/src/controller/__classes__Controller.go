...
import (
    ${className}DAO "${appName}/internal/dao"
    "${appName}/internal/model"
    "${appName}/internal/utils"
	"encoding/json"
	"fmt"
...
#set( $parentName  = $classObject.getName() )
	...
	///----------------------------------------------------------------------------
func Assign${roleName}To${parentName}(w http.ResponseWriter, r *http.Request) {
	...
	//----------------------------------------------------------------------------
	requestResult := ${parentName}DAO.Assign${roleName}To${parentName}(${lowercaseClassName}Id, ${lowercaseRoleName}Id)
	...
	//----------------------------------------------------------------------------
func Unassign${roleName}From${parentName}( w http.ResponseWriter, r *http.Request ) {
	...
	// Delegate to the ${parentName} DAO
	//----------------------------------------------------------------------------
	requestResult := ${parentName}DAO.Unassign${roleName}From${parentName}(${lowercaseClassName}Id)
...
#set( $parentName  = $classObject.getName() )
	...
	//----------------------------------------------------------------------------
func Add${roleName}To${parentName}(w http.ResponseWriter, r *http.Request)  {
	...
	// Delegate to the ${parentName} DAO
	//----------------------------------------------------------------------------
	requestResult := ${parentName}DAO.Add${roleName}To${parentName}(${lowercaseClassName}Id, ${lowercaseRoleName}Ids)
	...
	//----------------------------------------------------------------------------
func Remove${roleName}From${parentName}(w http.ResponseWriter, r *http.Request)  {
	...
	// Delegate to the ${parentName} DAO
	//----------------------------------------------------------------------------
	requestResult := ${parentName}DAO.Remove${roleName}From${parentName}(${lowercaseClassName}Id, ${lowercaseRoleName}Ids)
