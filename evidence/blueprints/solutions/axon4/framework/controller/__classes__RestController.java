...
#set( $imports = [ "api", "delegate", "entity", "exception" ] )
#importStatements( $imports )

/**
 * ${className}RestController as REST API
 *
 * <p>Exposes REST endpoints for the ${className} entity.</p>
 *
#generatedFrom()
 *
 * <h3>Services Used</h3>
 ...
 *      <li></li>${classObject.getUpdateCommandAlias()}</li>
