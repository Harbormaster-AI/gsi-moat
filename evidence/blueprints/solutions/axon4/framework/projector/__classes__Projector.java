...
/**
 * <h2>${className}Projector</h2>
 * <p>
 * The ${className} Projector is responsible for maintaining the read model for
 * ${className} entities. It subscribes to domain events published by the ${className}
 ...
 *		<ul>
 *      <li>Find${className}Query</li>
 *      <li>FindAll${className}Query</li>
 *		</ul>
 *
...
public class ${className}Projector extends ${className}EntityProjector {
	...
	// core constructor
	public ${className}Projector(ProjectorRegistry registry,
