 ...
 * related to ${className} are handled here as external events are delegated to an associated Aggregate.
 *
#generatedFrom()
 *
 * Services Used
 *
 *  	Repository<${className}Aggregate>
 *
 * Produces
 *
 *      application/json
 ...
 * Commands Accepted
 *
 *      ${classObject.getCreateCommandAlias()}
 *      ${classObject.getUpdateCommandAlias()}
 *      ${classObject.getDeleteCommandAlias()}
 *
