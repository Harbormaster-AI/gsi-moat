...
| Target Category                         | CIO | Chief Architect | Application Portfolio Owner | Corporate Development |
|-----------------------------------------|---|---|---|---|
| 🏛️ Large Enterprise                     | Lower the cost and increase the capacity of software production and modernization across the enterprise. | Turn enterprise architecture standards, engineering knowledge and proven patterns into reusable, executable production capability. | Modernize more applications, reduce production effort, and increase the value delivered by the application portfolio. | Identify a strategic capability that can increase enterprise productivity, accelerate modernization, and create durable competitive advantage. |
| ☁️ Public Cloud Provider                | Increase cloud consumption by making more applications economically viable to create and modernize. | Make cloud architecture patterns reusable and executable across a larger population of applications. | Make more applications candidates for modernization and deployment onto the cloud platform. | Identify technology and ecosystem opportunities that can increase application-driven cloud consumption and strengthen platform differentiation. |
| 🏢 GSI / Software Delivery Organization | Increase delivery capacity and improve the economics of software services without proportional headcount growth. | Convert accumulated engineering expertise into reusable production IP that improves delivery consistency. | Deliver application modernization and new systems faster while reducing repetitive engineering effort. | Identify a path to structurally improve delivery economics, increase capacity, and create differentiated intellectual property. |
| ☁️🏢 GSI + Private/Hybrid Cloud         | Expand revenue across software delivery, infrastructure and cloud operations through more economically viable applications. | Unify application, infrastructure and cloud architecture into reusable production capability. | Move more applications from modernization projects into repeatable deployment and infrastructure services. | Identify an opportunity to expand revenue across software, infrastructure and cloud while creating a differentiated end-to-end capability. |
